package muwanguzi.journalapp.sqlitedbhelper;
...
public class LogTableHelper extends SQLiteOpenHelper{
	...
	public boolean insertLog(String loguid,String logtitle,String logsummary,String date) {
		
		SQLiteDatabase db=this.getWritableDatabase();
		ContentValues contentValues=new ContentValues();
		  contentValues.put("uid",loguid);
	...
	public boolean updateLog(String id,String uloguid,String ulogtitle,String ulogsummary)
	{
		/*
		 * UPDATE table_name
	...
	public Cursor fetchReport() {
		// TODO Auto-generated method stub
		SQLiteDatabase db=this.getReadableDatabase();
		//Cursor mCursor=db.rawQuery("select * from log where uid="+uid,null);
	//	return cr.getCount();


	Cursor mCursor = db.query(TABLE_LOG, new String[] {LOG_ID,
			    LOG_TITLE, LOG_DATA,LOG_DATE},null, null, null, null, null);
